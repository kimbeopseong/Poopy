package com.mally.poopy.ui.camera;
...
import com.mally.poopy.utils.Cat;
...
public class CameraCatChoiceAdapter extends FirestorePagingAdapter<Cat, CameraCatChoiceAdapter.ViewHolder> {
    ...
    public CameraCatChoiceAdapter(FirestorePagingOptions<Cat> options, OnListItemClick onListItemClick){
        super(options);
